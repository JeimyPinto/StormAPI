    ...
    return (
        <>
            <Header className="flex flex-row">
                <button className="bg-gradient-to-r from-indigo-500 to-blue-500 text-white font-bold rounded p-2">Iniciar Sesión</button>
            </Header>
            <div className="flex flex-col w-full items-center text-center py-12">
                ...
                <div action="" className="flex flex-col w-3/5 items-center my-3 mx-8 p-10 border-double border-4 border-gray-500/8">
                    ...
                    <input type="email" placeholder="Escribe tu correo electrónico" className="w-8/12 mb-5 px-10 py-2 border text-center border-sky-500" />
                    <button className="bg-gradient-to-r from-indigo-500 to-blue-500 text-white font-bold rounded p-4">Registrate</button>
                </div>
